...
import (
	...
	"github.com/MrDarkCoder/productapi/SDK/models"
)
...
func (o *CreateProductParams) WithBody(body *models.MyProduct) *CreateProductParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create product params
func (o *CreateProductParams) SetBody(body *models.MyProduct) {
	o.Body = body
}
